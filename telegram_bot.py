...
def _groq_reply(query: str) -> str:
    ...
    system_msg = {
        ...
        "content": (
            ...
            "PLAIN LANGUAGE: Assume the reader may not know trading terms. The first time you "
            "use any jargon (RSI, ATR, MACD, EMA, support, resistance, RS, TT, R:R, etc.), add a "
            "few plain words explaining it in parentheses. Say the everyday meaning, not just the "
            "abbreviation, so a beginner still understands.\n\n"
